        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-black-900 rounded-xl p-6 w-full max-w-lg border border-gray-700 max-h-[90vh] overflow-y-auto"
            >
              {/* Header */}
              ...
              {/* Test Result Summary */}
              <div className="bg-black-800 rounded-lg p-4 mb-6 border border-gray-700">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-black-700 border border-gray-600 rounded-lg text-white"
                    >
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        value={shareUrl}
                        readOnly
                        className="flex-1 px-3 py-2 bg-black-700 border border-gray-600 rounded-lg text-white text-sm"
                      />
                      <Button
